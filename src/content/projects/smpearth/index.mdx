---
title: 'SMPEarth'
description: 'A spiritual successor to the SMPLive Minecraft server, set on a scale map of Earth'
date: 'Nov 22 2019'
projectURLs:
  - label: 'wiki'
...
<ImageCard
  imagePath='/src/content/projects/smpearth/smpearth-christmas-map.webp'
  altText="screenshot of SMPEarth's map, Christmas 2019"
  name='SMPEarth'
/>
...
<ImageCard
  imagePath='/src/content/projects/smpearth/intcraft-mascot.webp'
  altText="/int/craft's mascot, intchan"
  name='/int/craft'
  rounded={false}
  showShadow={false}
  showCaption={true}
...
The idea of SMPEarth was concieved in an Among Us hosted in [JunkyJanker](https://www.youtube.com/@JunkyJanker)'s Discord server, _Funny Club_.
...
<Tweet
  source='/src/content/projects/smpearth/origin-of-smpearth.webp'
...
My friends were on board the second I blurted out the idea. [JunkyJanker](https://www.youtube.com/@JunkyJanker) started selling the idea of "Earth SMP" to everyone he knew before we had even settled on a name. [LukeOrSomething](https://youtube.fandom.com/wiki/LukeOrSomething), [RobTob](https://youtube.fandom.com/wiki/RobTob), [InkTea](https://youtube.fandom.com/wiki/InkTea), [BrodyAnimates](https://youtube.fandom.com/wiki/BrodyAnimates), and [BrodyAnimates](https://youtube.fandom.com/wiki/BrodyAnimates) had already started helping me work on a pitch document. [stann.co](https://x.com/stann_co) didn't do anything but would feel sad if I didn't mention him. And everyone else did a lot of the same that I honestly don't even remember at this point.
...
<Tweet
  source='/src/content/projects/smpearth/smpearth-wilbur-tweet.webp'
  pfp='/src/content/projects/smpearth/wilbur-pfp.webp'
...
<DiscordConversation>
  <DiscordMessage
    ...
    avatar='/src/content/projects/smpearth/chip-pfp.webp'
  />
...
<DiscordMessage
  ...
  avatar='/src/content/projects/smpearth/wilbur-pfp.webp'
/>
...
<ImageCard
  imagePath='/src/content/projects/smpearth/smpearth-josh-missing.webp'
  altText="a screenshot of JoshA20's deleted Twitter account"
  name='SMPEarth'
  scale={0.85}
/>
...
<Tweet
  source='/src/content/projects/smpearth/smpearth-josha20-sus.webp'
  pfp='/src/content/projects/smpearth/josha20-pfp.webp'
  text="🖕 xmc/draxxis - they said it! ha! 1st customer. 
  
  RT @AbsoluteMC - Happy Birthday from the entire AMC team to @JoshA20_! 🎉
  Our first ever customer, the man who helped AbsoMC rise off the ground
  and into the wide world who's now a part of..."
  name='Josh'
  handle='JoshA20_'
  likes='34'
  replies='3'
...
<ImageCard
  imagePath='/src/content/projects/smpearth/smpearth-epstein.webp'
  altText="a screenshot of the official SMPEarth twitter page, clearly showing Epstein's temple in the header"
  name='SMPEarth'
/>
...
<ImageCard
  imagePath='/src/content/projects/smpearth/smpearth-prism-shirt.webp'
  altText='a screenshot of the SMPEarth merch store'
  name='SMPEarth'
  scale={0.85}
/>
...
<Tweet
  source='/src/content/projects/smpearth/smpearth-merch-claim.webp'
  pfp='/src/content/projects/smpearth/smpearth-logo.webp'
...
<ImageCard
  imagePath='/src/content/projects/smpearth/smpearth-prism-shirt.webp'
  altText='a T-shirt I designed for the SMPEarth merch store'
  name='SMPEarth'
  scale={0.6}
  showCaption={false}
/>
...
<ImageCard
  imagePath='/src/content/projects/smpearth/smpearth-public-creators.webp'
  altText='a screenshot of the SMPEarth public server website advertising me as one of the creators'
  name='SMPEarth'
  scale={0.75}
/>
...
<ImageCard
  imagePath='/src/content/projects/smpearth/smpearth-arg.webp'
  altText='a screenshot from one of the structures in my ARG'
  name='SMPEarth'
/>
...
<ImageCard
  imagePath='/src/content/projects/smpearth/smpearth-arg-specto.webp'
  altText='a spectogram from one of the ARG clues'
  name='SMPEarth'
/>
...
<ImageCard
  imagePath='/src/content/projects/smpearth/smpearth-arg-countdown.webp'
  altText='source: https://smpearth.fandom.com/wiki/6542_Countdown'
  name='SMPEarth'
  scale={0.85}
/>
...
<ImageCard
  imagePath='/src/content/projects/smpearth/smpearth-arg-thank-you.webp'
  altText='a thank you message from the SMPEarth subreddit'
  name='SMPEarth'
  showCaption={false}
/>
...
<DiscordConversation archive="/src/content/projects/smpearth/smpearth-chatlogs.webp">
<DiscordMessage
  author='Deleted User'
  ...
  avatar='/src/content/projects/smpearth/discord-pfp.webp'
/>
<DiscordMessage
  date='04/04/2020 2:16 PM'
  author='Brody'
  ...
  avatar='/src/content/projects/smpearth/brody-pfp.webp'
/>
<DiscordMessage
  author='Deleted User'
...
<ImageCard
  imagePath='/src/content/projects/smpearth/chippledipple-kpoomer.webp'
  altText='Screenshot of me antagonizing people in 2019. Old habits die hard, I guess.'
  name='SMPEarth'
/>
...
<Tweet
  source='/src/content/projects/smpearth/smpearth-announcement.webp'
  pfp='/src/content/projects/smpearth/smpearth-logo.webp'
...
<DiscordConversation archive='/src/content/projects/smpearth/smpearth-josh-message-2.webp'>
  <DiscordMessage
    author='Josh_'
    date='06/06/2020'
    content={[
    ...
    avatar='/src/content/projects/smpearth/josha20-pfp.webp'
  />
</DiscordConversation>

Within hours of my dismissal, his public opinion towards me did a complete 180.

<DiscordConversation archive='/src/content/projects/smpearth/smpearth-josh-message-5.webp'>
  <DiscordMessage
    author='Josh_'
    date='06/06/2020'
    content={[
...
<DiscordConversation archive='/src/content/projects/smpearth/smpearth-josh-message-3.webp'>
  <DiscordMessage
    author='Josh_'
    date='06/06/2020'
    content={[
...
<ImageCard
  imagePath='/src/content/projects/smpearth/smpearth-bwu-huh.webp'
  altText='JoshA20 flip flopping'
  scale={0.75}
  showCaption={false}
/>
...
<DiscordConversation archive='/src/content/projects/smpearth/smpearth-grilling-josh.webp'>
  <DiscordMessage
    author='Grunk'
    ...
    avatar='/src/content/projects/smpearth/grunk-pfp.webp'
  />
  <DiscordMessage
    author='JoshA20'
    date='Today at 10:20 PM'
...
<DiscordConversation archive='/src/content/projects/smpearth/smpearth-josh-pleading.webp'>
  <DiscordMessage
    author='Josh'
    date='10:11 PM'
    content={[
...
<Tweet
  source='/src/content/projects/smpearth/smpearth-attempt.webp'
  pfp='/src/content/projects/smpearth/smpearth-logo.webp'
...
<ImageCard
  imagePath='/src/content/projects/smpearth/smpearth-bedhead-bernie-mc.webp'
  altText='One of the first interactions I had with Bedhead Bernie'
  showShadow={false}
  rounded={false}
  scale={0.75}
/>
