...
As the workload only increased, I quickly burned out and neglected my duties less and less. Instead of doing the smart thing by downloading the server files and high-tailing it to a new server host, I pussyfooted around the issue out of fear of upsetting the hosting company and the creators relying on the server to put food on the table (exact quote of what I was told).
