...
<ContentImage src={'./intcraft-mascot.webp'} style={false} alt='/int/chan, the official mascot of /int/craft' />
...
<ContentImage src='./smpearth-josh-missing.webp' alt="a screenshot of JoshA20's deleted Twitter account" size='sm'/>
...
![a screenshot of the official SMPEarth twitter page with a header image that clearly depicts Jeffery Epstein's temple on Little St. James Island](./smpearth-epstein.webp)
...
<ContentImage
  ...
  alt='a screenshot of the SMPEarth public server website advertising me as one of the creators'
...
<ContentImage
  ...
  alt='a screenshot from one of the structures in the "Laramie Online" ARG'
  title='SMPEarth ARG'
/>
...
<ContentImage
  ...
  alt="a screenshot of the SMPEarth website's countdown timer"
